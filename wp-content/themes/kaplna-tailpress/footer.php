...
<?php do_action( 'tailpress_content_end' ); ?>
    <footer class="w-full flex flex-col items-center absolute bottom-0">
        <div class="upper-footer w-[calc(100%-3rem)] 2xs:w-[calc(100%-6rem)] md:w-full max-w-4xl ml-12 2xs:ml-24 md:mx-24 md:p-10 px-4 md:px-20 flex justify-evenly gap-4 md:gap-10 pb-4">
